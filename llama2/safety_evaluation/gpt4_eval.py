############ GPT-4 Judge ##################
'''
python safety_evaluation/gpt4_eval.py --input_file hexphi_purebad100_7b_full.jsonl
'''
...
def main(
    input_file="hexphi_llama2_7b_chat.jsonl",
    model_id=None,
    **kwargs
):
    ...
    input_file = f'safety_evaluation/question_output/{input_file}'
